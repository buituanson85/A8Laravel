    ...
    <div class="container">
        <nav class="biolife-nav">
            <ul>
                ...
                <li class="nav-item"><span class="current-page">All Product</span></li>
            </ul>
        </nav>
    </div>
                            ...
                            <li class="product-item">
                                <div class="contain-product layout-02">
                                    <div class="product-thumb">
                                        <a href="{{ route('single-products.show', $product_slider->id) }}" class="link-to-product">
                                            <img src="{{ asset('assets/uploads/products') }}/{{ $product_slider->image }}" alt="dd" width="270" height="270" class="product-thumnail">
                                        </a>
                                    </div>
                                    <div class="info">
                                        <b class="categories">{{ $product_slider->category->name }}</b>
                                        <h4 class="product-title"><a href="#" class="pr-name">{{ $product_slider->name }}</a></h4>
                                        <div class="price">
                                            <ins><span class="price-amount"><span class="currencySymbol">£</span>{{ $product_slider->sale_price }}</span></ins>
                                            <del><span class="price-amount"><span class="currencySymbol">£</span>{{ $product_slider->regular_price }}</span></del>
                                        </div>
                                    </div>
                                </div>
                            </li>
                                    ...
                                    <div class="contain-product layout-default">
                                        <div class="product-thumb">
                                            <a href="{{ route('single-products.show', $product->id) }}" class="link-to-product">
                                                <img src="{{ asset('assets/uploads/products') }}/{{ $product->image }}" alt="dd" width="270" height="270" class="product-thumnail">
                                            </a>
                                        </div>
                                        <div class="info">
                                            ...
                                            <div class="price">
                                                <ins><span class="price-amount"><span class="currencySymbol">£</span>{{ $product->sale_price }}</span></ins>
