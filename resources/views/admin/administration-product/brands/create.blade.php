        ...
        <div class="container-fluid">
            <div class="row">
                <ul class="float-left">
                    ...
                    <li style="float: left; margin: 0 10px;list-style: none">/</li>
                    <li style="float: left;list-style: none"><a class="longin-a" href="{{ route('brands.create') }}">Create Brands</a></li>
                </ul>
            </div>
            <hr>
                    ...
                    <div class="col-md-10 offset-1">
                        <div class="card">
                            <div class="card-heard" style="padding: 30px 0 20px 0">
                                <div class="row">
                                    <div class="col-md-6">
                                        <h3 class="card-title pl-5 text-uppercase font-18">Create Brand</h3>
                                    </div>
                                    <div class="col-md-6 pr-5" >
                                        <div class="card-tools" style="float: right;">
                                            <a href="{{ route('brands.index') }}" class="btn btn-primary"><i class="fas fa-plus-circle"></i> Table Brands</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <hr>
                            <form class="form-horizontal" id="brandForm" action="{{ route('brands.store') }}" method="post" enctype="multipart/form-data">
                                @csrf
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-10 offset-md-2">
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-10">
                                                <input type="text" placeholder="Brand Name" id="name" onkeyup="ChangeToSlug()" name="name" class="form-control input-md" data-parsley-trigger="keyup">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-10">
                                                <input type="text" placeholder="Brand Slug" id="slug" name="slug" class="form-control input-md" data-parsley-trigger="keyup">
                                            </div>
                                        </div>
