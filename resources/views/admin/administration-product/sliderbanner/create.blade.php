        ...
        <div class="container-fluid">
            <div class="row">
                <ul class="float-left">
                    ...
                    <li style="float: left; margin: 0 10px;list-style: none">/</li>
                    <li style="float: left;list-style: none"><a class="longin-a" href="{{ route('sliderbanner.create') }}">Create Slider Banner</a></li>
                </ul>
            </div>
            <hr>
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-heard" style="padding: 30px 0 20px 0">
                                <div class="row">
                                    <div class="col-md-6">
                                        <h3 class="card-title pl-5 text-uppercase font-18">Create Slider Banner</h3>
                                    </div>
                            ...
                            <hr>
                            <form class="form-horizontal" id="imageForm" action="{{ route('sliderbanner.store') }}" method="post" enctype="multipart/form-data">
                                @csrf
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        <div class="row">
                                            <div class="col-md-6">
                                                <label for="" class="col-md-10 control-label" >Slider Name</label>
                                                <div class="col-md-10">
                                                    <input type="text" name="name" id="name" value="" placeholder="Slider Name" class="form-control input-md" required  data-parsley-trigger="keyup">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="col-md-10">
                                                    <input type="text" name="regular_price" id="regular_price" value="" placeholder="Images Regular Price" class="form-control input-md" required  data-parsley-trigger="keyup">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="col-md-10">
                                                    <input type="text" name="sale_price" id="sale_price" value="" placeholder="Images Sale Price" class="form-control input-md" required  data-parsley-trigger="keyup">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="col-md-10">
                                                    <input type="text" name="title_one" id="title_one" value="" placeholder="Images Title One" class="form-control input-md" required  data-parsley-trigger="keyup">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="col-md-10">
                                                    <input type="text" name="title_two" id="title_two" value="" placeholder="Images Title Two" class="form-control input-md" required  data-parsley-trigger="keyup">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="col-md-10">
                                                    <input type="text" name="title_three" id="title_three" value="" placeholder="Slider Title Three" class="form-control input-md" required  data-parsley-trigger="keyup">
                                                </div>
                                            </div>
