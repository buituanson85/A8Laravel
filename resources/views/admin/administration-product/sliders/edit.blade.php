        ...
        <div class="container-fluid">
            <div class="row">
                <ul class="float-left">
                    ...
                    <li style="float: left; margin: 0 10px;list-style: none">/</li>
                    <li style="float: left;list-style: none"><a class="longin-a" href="{{ route('sliders.index') }}">Edit Sliders</a></li>
                </ul>
            </div>
            <hr>
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-heard" style="padding: 30px 0 20px 0">
                                <div class="row">
                                    <div class="col-md-6">
                                        <h3 class="card-title pl-5 text-uppercase font-18">Edit Sliders</h3>
                                    </div>
                            ...
                            <hr>
                            <form class="form-horizontal" id="imageForm" action="{{ route('sliders.update', $slider->id) }}" method="post" enctype="multipart/form-data">
                                @csrf
                                @method('PUT')
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        <div class="row">
                                            <div class="col-md-6">
                                                ...
                                                <div class="col-md-10">
                                                    <input type="text" name="name" id="name" value="{{ $slider->name }}" class="form-control input-md" required  data-parsley-trigger="keyup">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="col-md-10">
                                                    <input type="text" name="title" id="title" value="{{ $slider->title }}" class="form-control input-md" required  data-parsley-trigger="keyup">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="col-md-10">
                                                    <input type="text" name="short_description" id="short_description" value="{{ $slider->short_description }}"class="form-control input-md" required  data-parsley-trigger="keyup">
                                                </div>
                                            </div>
                                                ...
                                                <div class="col-md-6">
                                                    <select class="form-control" name="species" id="species" required data-parsley-trigger="keyup">
                                                        ...
                                                        @if($slider->species === 'one')
                                                            <option selected value="one">Slider Header</option>
                                                            <option value="two">Slider Banner</option>
                                                        @else
                                                            <option value="one">Slider Header</option>
                                                            <option selected value="two">Slider Banner</option>
                                                        @endif
                                                    </select>
                                                </div>
                                            </div>
                                                    ...
                                                    <div class="col-md-6">
                                                        ...
                                                        <div class="col-md-6">
                                                            ...
                                                            <div class="image-preview" id="imagePreview">
                                                                <img class="image-preview__image" width="150px" src="{{ $slider->image }}" id="img_thumbnail" alt="">
