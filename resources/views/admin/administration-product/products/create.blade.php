                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-heard" style="padding: 30px 0 20px 0">
                                <div class="row">
                                    <div class="col-md-6">
                                        <h3 class="card-title pl-5 text-uppercase font-18">Create Product</h3>
                                    </div>
                                    <div class="col-md-6 pr-5" >
                                        <div class="card-tools" style="float: right;">
                                            <a href="{{ route('products.index') }}" class="btn btn-primary"><i class="fas fa-plus-circle"></i> Table Category</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <hr>
                            <form class="form-horizontal" id="productForm" action="{{ route('products.store') }}" method="post" enctype="multipart/form-data">
                                @csrf
                            <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        <div class="row">
                                            <div class="col-md-6">
                                                ...
                                                <div class="col-md-10">
                                                    <input type="text" name="name" id="name" onkeyup="ChangeToSlug()" placeholder="Product Name" class="form-control input-md" required  data-parsley-trigger="keyup">
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <label for="" class="col-md-10 control-label" >Slug</label>
                                                <div class="col-md-10">
                                                    <input type="text" placeholder="Slug" id="slug" name="slug" class="form-control input-md" required data-parsley-trigger="keyup">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <div class="row">
                                            <div class="col-md-6">
                                                ...
                                                <div class="col-md-10">
                                                    <textarea class="form-control" name="short_description" id="short_description" data-parsley-trigger="keyup"></textarea>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <label for="" class="col-md-10 control-label" >Description</label>
                                                <div class="col-md-10">
                                                    <textarea class="form-control" id="description" name="description" required data-parsley-trigger="keyup"></textarea>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <div class="row">
                                            <div class="col-md-6">
                                                ...
                                                <div class="col-md-10">
                                                    <input type="text" placeholder="Regular Price" id="regular_price" name="regular_price" class="form-control input-md" data-parsley-type="number" required data-parsley-trigger="keyup">
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <label for="" class="col-md-10 control-label" >Sale Price</label>
                                                <div class="col-md-10">
                                                    <input type="text" placeholder="Sale Price" id="sale_price" name="sale_price" class="form-control input-md" required data-parsley-type="number" data-parsley-trigger="keyup">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <div class="row">
                                            <div class="col-md-6">
                                                ...
                                                <div class="col-md-10">
                                                    <input type="text" placeholder="Quantity" id="quantity" name="quantity" class="form-control input-md" data-parsley-type="number" required data-parsley-trigger="keyup">
                                                </div>
...
{{--                                                            @endif--}}
                                                ...
                                                <div class="col-md-6 pt-3">
                                                    <label for="" class="col-md-6 control-label" >Brand</label>
                                                    <div>
