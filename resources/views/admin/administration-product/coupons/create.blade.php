        ...
        <div class="container-fluid">
            <div class="row">
                <ul class="float-left">
                    ...
                    <li style="float: left; margin: 0 10px;list-style: none">/</li>
                    <li style="float: left;list-style: none"><a class="longin-a" href="{{ route('coupons.create') }}">Create Coupon</a></li>
                </ul>
            </div>
            <hr>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 pr-5" >
                                        <div class="card-tools" style="float: right;">
                                            <a href="{{ route('coupons.index') }}" class="btn btn-primary"><i class="fas fa-plus-circle"></i> Table Category</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <hr>
                            <form class="form-horizontal" id="categoryForm" action="{{ route('coupons.store') }}" method="post">
                                @csrf
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-md-10 offset-md-2">
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-10">
                                                    <input type="text" placeholder="Coupon Name" id="name" name="name" class="form-control input-md" data-parsley-trigger="keyup">
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-10">
                                                    <input type="text" placeholder="Code Coupon" id="code" name="code" class="form-control input-md" data-parsley-trigger="keyup">
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-10">
                                                    <input type="text" placeholder="Quantity Coupon" id="quantity" name="quantity" class="form-control input-md" data-parsley-trigger="keyup">
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-10">
                                                    <input type="text" placeholder="Enter the % or discount amount" id="price" name="price" class="form-control input-md" data-parsley-trigger="keyup">
                                                </div>
                                            </div>
